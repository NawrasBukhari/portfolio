...
<section class="error">
  ...
  <div class="error__content">
    <div class="error__message message">
      ...
      <p class="message__text">We're sorry, the page you were looking for isn't found. Check Your spelling again!</p>
    </div>
    <div class="error__nav e-nav">
      <a href="http://localhost/porto/index.php" target="_blanck" class="e-nav__link"></a>
    </div>
  </div>
  <!-- END Content -->
