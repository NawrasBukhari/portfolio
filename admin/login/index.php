...
?> 
  <img class="mb-4" src="../assets/brand/logome.png" style="color: transparent; background: transparent;" alt="" width="300" height="120">
  ...
  <p class="mt-5 mb-3 text-muted">&copy; Nawras Bukhari 2021</p>
</form>
</body>
</html>
